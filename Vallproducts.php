...
-->
          <li class="dropdown">
            <a class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center" href="#"
              id="dropdownMenuButton" role="button" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <button class="btn dropdown-toggle btn-link  text-dark" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
              produit
            </button>
            </a>
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <li class="nav-item dropdown">
            <button class="nav-link me-3 me-lg-0 dropdown-toggle hidden-arrow" href="#" id="navbarDropdownMenuLink"
