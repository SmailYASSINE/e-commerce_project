...
if($_FILES["image1"]["error"]==0 && $_FILES["image2"]["error"]==0 && $_FILES["image3"]["error"]==0 )
{
	...
	$id_image3=uniqid();
		...
		move_uploaded_file($_FILES["image1"]["tmp_name"],  "C:/xampp/htdocs/photos/".$id_image1.".jpeg");
		move_uploaded_file($_FILES["image2"]["tmp_name"], "C:/xampp/htdocs/photos/".$id_image2.".jpeg");
		move_uploaded_file($_FILES["image3"]["tmp_name"], "C:/xampp/htdocs/photos/".$id_image3.".jpeg");
